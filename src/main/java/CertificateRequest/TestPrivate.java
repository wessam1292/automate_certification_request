...
public class TestPrivate {
    WebDriver driver;
    DevTools devTools;
    public String filepath = System.getProperty("user.dir")+"//Excelfile//privatecert.xlsx";
    ...
    public void start () throws InterruptedException {
       ...
       WebDriverManager.chromedriver().setup();
        ...
        driver.get("https://wessam.gamal1@vodafone.com:Wesso1292@enrol.pki.vodafone.com/aspx/certificate/CertificateIssuancePkcs10View.aspx");
        Thread.sleep(5000);
    ...
    public void wessam(String fname, String lname , String email ,String remail, String filename) throws InterruptedException, AWTException {
        ...
        //driver.get("https://wessam.gamal1@vodafone.com:Gemy0501@enrol.pki.vodafone.com/aspx/certificate/CertificateIssuancePkcs10View.aspx");
