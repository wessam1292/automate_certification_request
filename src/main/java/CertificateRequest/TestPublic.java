...
public class TestPublic {
    WebDriver driver;
    public int trials = 0;
    public String filepath = System.getProperty("user.dir")+"//Excelfile//sheet1.csv";
   ...
   // public void Vodafone(String fname, String lname , String email ,String remail, String filename) throws InterruptedException, AWTException {
    public void Vodafone( String filename) throws InterruptedException, AWTException {
        ...
        driver.findElement(By.name("guest_requester_first_name")).sendKeys("DL");
        driver.findElement(By.name("guest_requester_last_name")).sendKeys("TSSE-Enablers-GASF");
        driver.findElement(By.name("guest_requester_email")).sendKeys("dl-tsse-enablers-gasf@vodafone.com");
        ...
        trials++;
        // handling CSR upload
        String csrpath = System.getProperty("user.dir")+"\\CSR\\"+filename;
        ...
        driver.findElement(By.xpath("//*[@id=\"request-form\"]/div[4]/div/div/div[1]/ul/li/input")).sendKeys("dl-tsse-enablers-gasf@vodafone.com");
